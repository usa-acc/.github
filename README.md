...
This public repository is the canonical source for GitHub-supported community-health fallbacks, organization profile content, contribution guidance, public security/support policy, issue and pull-request templates, and agent-governance declarations for [`usa-acc`](https://github.com/usa-acc).

## Canonical organization links

- GitHub organization: https://github.com/usa-acc
- Public organization defaults: https://github.com/usa-acc/.github
- Canonical Linear project: https://linear.app/denman/project/githubcomusa-acc-112232184d74
...
`usa-acc` declares repository roles, dependency edges, cross-organization capabilities, deployment ownership, and the git-submodule/Zed-package contract:
