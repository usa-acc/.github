...
# Repository relationships for `usa-acc`
...
- Inventory digest: `sha256:6fba074af201784e4a0ba67eb1386df976cadb563f5d88f5af7cf5cb651ce400`

## Immutable routing identity

| Field | Value |
|---|---|
| Mapping ID | `context:usa-acc` |
| GitHub owner ID | `292932113` |
| Linear project ID | `ed1f5d4e-4a8e-47e4-9149-0be068a07cbe` |
...
|---|---|---|---|
| `usa-acc/.github` | `public` | `community-health`, `governance`, `relationship-registry` | no |
| `usa-acc/usa-acc.github.io` | `public` | `documentation-site` | no |

## Relationships

| From | Type | To | Status | Required |
|---|---|---|---|---|
| `usa-acc/.github` | `governs` | `usa-acc/usa-acc.github.io` | `declared` | yes |
| `usa-acc/usa-acc.github.io` | `documents` | `usa-acc/.github` | `inferred` | no |
